...
double total_swaps_commissions;
...
void info_account(double &_initial_deposit,
                  ...
                  double &_total_swaps_commissions)
  {
...
//----------------Profit diario, profit en los ultimos 30 días y profit en las ultimas 4 semanas
            ...
            if(_current_day != 0)
              {
               ...
               ArrayResize(Array_Date, total_days);
               ArrayResize(Array_Swap, total_days);
               ...
               Array_Swap[total_days-1]              = daily_swap;

               if(running_balance != 0)
                  Array_Percent_Daily[total_days-1] = NormalizeDouble(100.0 * daily_profit / running_balance, 2);
               else
   ...
   for(int L = 0; L < ArraySize(Array_Profit_Daily); L++)
     {
      ...
      _total_swaps_commissions += Array_Commision[L] + Array_Swap[L];
   ...
   _total_swaps_commissions= NormalizeDouble(MathAbs(_total_swaps_commissions), 3);
   ...
   Print("_total_swaps_commissions: ", _total_swaps_commissions);
